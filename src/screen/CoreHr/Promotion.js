            ...
            documentData?.map((data, i) => (
              <TableCard
                ...
                datas={[
                  {
                    title: 'Employee',
                    value: data.promotion_employee_name,
                  },
                  {
                    title: 'Old Department',
                    value: data.promotion_old_department,
                  },
                  {
                    title: 'New Department',
                    value: data.promotion_new_department,
                  },

                  {
                    title: 'Old Designation',
                    value: data.promotion_old_designation,
                  },
                  {
                    title: 'New Designation',
                    value: data.promotion_new_designation,
                  },
                  {
                    title: 'Old Gross Salary',
                    value: data.promotion_old_gross_salary,
                  },
                  {
                    title: 'New Gross Salary',
                    value: data.promotion_new_gross_salary,
                  },
                  {
                    title: 'Title',
                  ...
                  {title: 'Description', value: data.promotion_description},
                ]}
                deleteButton={true}
                buttonVisible={false}
                variant="Immigration"
