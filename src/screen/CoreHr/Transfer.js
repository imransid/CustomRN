            ...
            documentData?.map((data, i) => (
              <TableCard
                ...
                datas={[
                  {
                    title: 'Employee',
                    value: data.transfer_employee_full_name,
                  },
                  {
                    title: 'Form Department',
                    value: data.transfer_from_department_name,
                  },
                  {
                    title: 'To Department',
                    value: data.transfer_to_department_name,
                  },

                  {
                    title: 'To Designation',
                    value: data.transfer_to_designation_name,
                  },
                  {
                    title: 'Transfer Date',
