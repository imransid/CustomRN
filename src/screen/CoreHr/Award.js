      ...
      <ScrollView>
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.pdfBox}>
            <RnPdf Filename={'Awards'} value={data[0]} />
          </View>
          {documentLoader ? (
            <CustomIndicator />
          ) : (
            documentData?.map((data, i) => (
              <TableCard
                ...
                datas={[
                  {
                    title: 'Employee',
                    value: data.award_employee_full_name,
                  },
                  {
                    title: 'Department',
                    value: data.award_employee_department_name,
                  },
                  {
                    title: 'Award Name',
                    value: data.award_type_name,
                  },
                  { title: 'Gift', value: data.award_gift },
                  { title: 'Cash', value: data.award_cash },
                  { title: 'Date', value: data.award_date },
                ]}
                deleteButton={true}
                buttonVisible={false}
                variant="Immigration"
