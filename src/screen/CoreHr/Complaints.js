          ...
          {documentLoader ? (
            ...
            documentData?.map((data, i) => (
              <TableCard
                ...
                datas={[
                  {
                    title: 'Complaint From Department',
                    value: data.complaint_from_department_name,
                  },
                  {
                    title: 'Complaint From Employee',
                    value: data.complaint_from_employee_name,
                  },
                  {
                    title: 'Complaint To Department',
                    value: data.complaint_to_department_name,
                  },

                  {
                    title: 'Complaint Against',
                    value: data.complaint_to_employee_name,
                  },
                  {
                    title: 'Complaint Date',
                    value: data.complaint_date,
                  },
                  { title: 'Complaint Title', value: data.complaint_title },
                  { title: 'Complaint Description', value: data.complaint_desc },
                ]}
                deleteButton={true}
                buttonVisible={false}
                variant="Immigration"
